...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumen — A quieter way to watch cinema" },
      { name: "description", content: "Lumen is a modern cinema companion: discover films, read reviews, and book tickets in a calm, elegant interface." },
      { property: "og:title", content: "Lumen — A quieter way to watch cinema" },
