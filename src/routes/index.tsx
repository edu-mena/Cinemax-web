...
function Home() {
  ...
  return (
    <div className="space-y-16">
      ...
      >
        <div className="grid gap-8 p-6 sm:p-10 md:grid-cols-[1fr_320px] md:items-center">
          <div className="min-w-0">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-hairline bg-surface-2 px-2.5 py-1 text-[11px] uppercase tracking-widest text-white/60">
              <Sparkles className="h-3 w-3 text-amber-300" strokeWidth={1.5} /> Featured this week
            </span>
          ...
          <div className="mx-auto w-full max-w-[280px] md:max-w-none">
            <PosterPlaceholder seed={hero.id + "-hero"} title={hero.title} />
          </div>
        </div>
      </motion.section>
